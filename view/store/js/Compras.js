...
fetch("/../../controller/ACTIONS/act_read-Compras.php?id=" + id_producto)
...
function Agregar_Producto() {
  A_Producto += 1;
  Numero = "Producto_" + A_Producto.toString();
  if (A_Producto <= 5) {
    Element_1 = document.createElement("div");
    Element_1.className = "Flex_Compras";
    Element_1.id = Numero;
...
function Valor_Total(Cantidad, SubPrecio) {
  Padre_2 = Cantidad.parentNode;
  Padre_1 = Padre_2.parentNode;
  Nombre_Padre = Padre_1.id;
...
function Factura_Final() {
  ...
  for (let i = 0; i < Perfumes.length; i++) {
    ...
    Nuevo_h4.className = "Total_Producto";
    Nuevo_h4.id = "Precio_Final";
  ...
  Nuevo_Final.className = "Total_Producto";
  Nuevo_Final.id = "Precio";
